...
\begin{itemize}
    ...
    \item Drove adoption of CICD pipeline reducing release time from 2 days to 1 hour.
    ...
    \item Drove 95\% reduction in number of 500 errors driving error rate from ~0.2\% to ~0.01\% which resulted is 5 point increase in CSAT and boosted SEO ranking.

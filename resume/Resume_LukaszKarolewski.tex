...
\homepage{3069 Jayhawkers Pl, Unit 4, San Jose, CA 95136}                   
...
\begin{itemize}
    ...
    \item Lead change in engineering organization to embrace test pyramid, introduced js based test framework, which improved efficiency.
...
\begin{itemize}
    ...
    \item Built is HIPAA compliant, streamlined communication workflow for healthcare providers recognized by KLAS and Gartner as \#1 vendor in the space.
...
\begin{itemize}
    ...
    \item Redesigned build process migrating it from ant to gradle reducing build time from 15min to under 1 min. Created new deployment model that utilized rpm and enabled fully automatic deployment. I was able to bring down deploy time to 1h from 3day manual process before.
\end{itemize}

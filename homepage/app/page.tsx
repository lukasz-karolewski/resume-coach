      ...
      <div className="max-w-4xl m-auto bg-white p-12 flex flex-col gap-4 shadow-lg print:shadow-none print:p-0 dark:bg-gray-800">
        ...
        <Section title="Experience">
          ...
          >
            <JobExperience.Accomplishments>
              <li>
                Responsible for all aspects of prospecting, outreach in the
                Sales Navigator - 80% of value prop of the 1.5B product.
              </li>
              <li>
              ...
              <li>
                ...
                and freshness, improved search precision for non-english
                queries.
              </li>
              ...
              <li>
                Drove hardware rightsizing initiative which resulted in $4M
                annual savings, improved query performance, relevance of
                results.
              </li>
            </JobExperience.Accomplishments>
          </JobExperience>
          ...
          >
            <ul className="text-sm flex flex-col gap-2">
              <li>
                ...
                <JobExperience.Accomplishments>
                  ...
                  <li>
                    ...
                    application. The new version had support for branding,
                    theming and was localized into 14 languages.
                  </li>
                  <li>
                    Achieved 70% code coverage in unit tests for frontend,
                    designed and implemented e2e automation reducing the number
                    of defects by 60%.
                  </li>
                </JobExperience.Accomplishments>
              </li>
              ...
              <li>
                ...
                <JobExperience.Accomplishments>
                  <li>
                    ...
                    multi-tiered enterprise web applications as well as web
                    services. Actively participating in all phases of the
                    software development life cycle including requirement
                    analysis, design, implementation, and testing. Actively
                    involved in the deployment of web application and services
                    to data centers as well as helping resolve technical issues
              ...
              <li>
                ...
                <JobExperience.Accomplishments>
                  <li>
                    Responsible for end to end analysis, design and
                    implementation of i18n features for multiple products in
          ...
          >
            <ul className="text-sm">
              <li>
                ...
                on inventory thresholds inquired for quotes, based on
                user-defined criteria picked the best bid, tracked payments and
                shipments. It was an extension of a well established ERP.
              </li>
            </ul>
          </JobExperience>
          ...
          >
            <ul className="text-sm">
              <li>
                ...
                operations, most notably: billing, traffic shaping, captive
                portal for device registration. Sold business to a larger ISP.
              </li>
            </ul>
          </JobExperience>
        </Section>
